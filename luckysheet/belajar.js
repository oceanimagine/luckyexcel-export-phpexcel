...
{1:[function(require,module,exports){
    ...
    var kamu = function () {
        ...
        kamu.prototype.unzipFile = function(masuk){
            console.log(masuk);
        }
        return kamu;
    }();
    ...
    console.log("MASUK 94");
    exports.coba = void 0;
    var coba = function () {
        function coba(masuk) {
            console.log(masuk);
        }
        coba.prototype.unzipFile = function(masuk){
            console.log(masuk);
        }
        return coba;
    }();
    ...
    var saya = require("./saya");
    new main_1.coba("SAYA").unzipFile("KAMU");
    new saya.kamu("SAYA").unzipFile("KAMU");
},{"./main":94,"./saya":1}]},{},[95])(95)
});